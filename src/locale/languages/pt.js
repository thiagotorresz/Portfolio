  ...
  pt: {
    locale: {
      header: {
        ...
        resume: {
          name: 'Currículo',
          downloadName: 'thiago_torres_curriculo',
          downloadMessage: 'Baixando currículo',
        },
      },
      homeSection: {
        intro: 'Oi, eu sou Thiago Torres.',
        welcome: 'Bem vindos a Torres Dev',
        smallDescription: 'Eu sou',
        animatedTexts: {
          textOne: 'Desenvolvedor Full-Stack',
          textTwo: 'Front-End',
          textThree: 'Backend',
          textFour: 'Desenvolvedor React',
          textFive: 'Desenvolvedor PHP',
          textSix: 'Estudante de Java',
        },
